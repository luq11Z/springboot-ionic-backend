...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Lucas", "luq1zin@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		
		Cliente cli2 = new Cliente(null, "Cris", "Cris@gmail.com", "75468274426", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfis(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363323", "914758188"));

		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", "Apto 303", "Jardim", "38220834", cli2, c1);
